/**
 * Blocks for driving the BLE Robot by ST
 */
//% weight=100 color=#00A654 icon="\uf1b9" block="BLE:Robot"
namespace ble_robot_st {
	...
	************************************************************************************************************************************************/
     ...
     */
    //% blockId=ble_robot_st_servos_forward
    //% block="drive forward"
     ...
     */
    //% blockId=ble_robot_st_servos_backward
	...
	*/
    //% blockId=ble_robot_st_servos_left
    //% block="turn left"
	 ...
	 */
    //% blockId=ble_robot_st_servos_right
    //% block="turn right"
     ...
     */
    //% blockId=ble_robot_st_servos_stop
    //% block="stop"
     ...
     */
    //% blockId=ble_robot_st_servos_neutral
     ...
     */
    //% blockId=ble_robot_st_drive_forwards
     ...
     * @param howFar distance to move
     */
    //% blockId=ble_robot_st_drive_backwards
     ...
     */
    //% blockId=ble_robot_st_turn_right
    ...
    * @param deg how far to turn, eg: 90
    */
    //% blockId=ble_robot_st_turn_left
     ...
     */
    //% blockId=ble_robot_st_set_turn_speed_param
     ...
     * @param DegPerSec : How many degrees per second the mini does.
     */
    //% blockId=ble_robot_st_set_movement_speed_param 
